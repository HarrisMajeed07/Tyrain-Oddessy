...
class Enemy:
    def __init__(self, x, y):
        ...
        self.attack_damage = random.uniform(1, 50)  # Attack damage between 1% and 50%
        self.speed = random.uniform(1, 3)  # Speed between 1 and 4
...
while True:
    ...
    # Player surface + Player animation
    player_surf = player_walk_forward[int(player_index)]  
